...
const applyReduxDevTools = (enhancer: StoreEnhancer): StoreEnhancer =>
  isProductionPlatformEnv() ? enhancer : composeWithDevTools(enhancer);
...
export const configureStore = () => {
  ...
  const store = createStore(
    ...
    applyReduxDevTools(applyMiddleware(routerMiddleware, sagaMiddleware))
  );
