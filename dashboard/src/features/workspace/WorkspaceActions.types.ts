import { GoogleRpcStatus, V1CreateOrganizationRequest, V1CreateWorkspaceRequest, V1Organization, V1OrganizationListResponse, V1OrganizationResponse, V1AuthenticatedUser, V1SignInRequest, V1WorkspaceResponse } from "../../api";
...
export type WorkspaceActionType = | IListOrganizationsRequest | IListOrganizationsSuccess | IListOrganizationsFailure
    | ICreateOrganizationRequest | ICreateOrganizationSuccess | ICreateOrganizationFailure
    | ICreateWorkspaceRequest | ICreateWorkspaceSuccess | ICreateWorkspaceFailure
    | IListWorkspacesRequest | IListWorkspacesSuccess | IListWorkspacesFailure
    | IAddWorkspaceMembersRequest | IAddWorkspaceMembersSuccess | IAddWorkspaceMembersFailure
