...
type InvitationResponse struct {
	...
	Invitations *Invitation `protobuf:"bytes,1,opt,name=invitations,proto3" json:"invitations,omitempty"`
}
...
func (x *InvitationResponse) GetInvitations() *Invitation {
	if x != nil {
...
func (x *InvitationListResponse) Reset() {
	*x = InvitationListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_users_v1_responses_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InvitationListResponse) Descriptor() ([]byte, []int) {
	return file_services_users_v1_responses_proto_rawDescGZIP(), []int{5}
}
...
var file_services_users_v1_responses_proto_rawDesc = []byte{
	...
	,
...
var file_services_users_v1_responses_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_services_users_v1_responses_proto_goTypes = []interface{}{
	...
	(*InvitationResponse)(nil),       // 4: v1.InvitationResponse
	(*InvitationListResponse)(nil),   // 5: v1.InvitationListResponse
	(*User)(nil),                     // 6: v1.User
	(*Organization)(nil),             // 7: v1.Organization
	(*Workspace)(nil),                // 8: v1.Workspace
	(*Invitation)(nil),               // 9: v1.Invitation
}
var file_services_users_v1_responses_proto_depIdxs = []int32{
	6, // 0: v1.AuthenticatedUser.user:type_name -> v1.User
	7, // 1: v1.OrganizationListResponse.organizations:type_name -> v1.Organization
	7, // 2: v1.OrganizationResponse.organization:type_name -> v1.Organization
	8, // 3: v1.WorkspaceResponse.workspace:type_name -> v1.Workspace
	9, // 4: v1.InvitationResponse.invitations:type_name -> v1.Invitation
	9, // 5: v1.InvitationListResponse.invitations:type_name -> v1.Invitation
...
func file_services_users_v1_responses_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_users_v1_responses_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
