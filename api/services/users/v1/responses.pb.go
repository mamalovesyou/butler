...
var file_services_users_v1_responses_proto_rawDesc = []byte{
	...
	0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_services_users_v1_responses_proto_goTypes = []interface{}{
	...
	(*User)(nil),                     // 4: v1.User
	(*Organization)(nil),             // 5: v1.Organization
	(*Workspace)(nil),                // 6: v1.Workspace
}
var file_services_users_v1_responses_proto_depIdxs = []int32{
	4, // 0: v1.AuthenticatedUser.user:type_name -> v1.User
	5, // 1: v1.OrganizationListResponse.organizations:type_name -> v1.Organization
	5, // 2: v1.OrganizationResponse.organization:type_name -> v1.Organization
	6, // 3: v1.WorkspaceResponse.workspace:type_name -> v1.Workspace
